...
int main(int argc, char **argv)
{
    ...
    while(ros::ok())
    {
	    ...
	    pose.pose.orientation.x = 0;
	    pose.pose.orientation.y = 0;
	    pose.pose.orientation.z = 0.7068252;
	    ...
	    pose.pose.orientation.x = 0;
	    pose.pose.orientation.y = 0;
	    pose.pose.orientation.z = 0.9999997;
	    pose.pose.orientation.w = 0.0007963;
	    ...
	    pose.pose.orientation.x = 0;
	    pose.pose.orientation.y = 0;
	    pose.pose.orientation.z = 0.2826855;
	    pose.pose.orientation.w = -0.9592126;
